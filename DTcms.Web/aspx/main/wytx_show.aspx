...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"网页特效");
	...
	templateBuilder.Append("\r\n        <li>\r\n          <h4><a href=\"");
	templateBuilder.Append(linkurl("wytx_list",Utils.ObjectToStr(cdr1["id"])));
	...
	templateBuilder.Append(linkurl("wytx_show",Utils.ObjectToStr(dr["id"])));
	...
	templateBuilder.Append(linkurl("wytx_show",Utils.ObjectToStr(hotdr["id"])));
	...
	templateBuilder.Append(get_prevandnext_article("wytx_show", -1, "没有了", 0).ToString());
