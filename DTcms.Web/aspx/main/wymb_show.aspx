...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"网页模板");
	...
	templateBuilder.Append("\r\n        <li>\r\n          <h4><a href=\"");
	templateBuilder.Append(linkurl("wymb_list",Utils.ObjectToStr(cdr1["id"])));
	...
	templateBuilder.Append(linkurl("wymb_show",Utils.ObjectToStr(dr["id"])));
	...
	templateBuilder.Append(linkurl("wymb_show",Utils.ObjectToStr(hotdr["id"])));
	...
	templateBuilder.Append(get_prevandnext_article("wymb_show", -1, "没有了", 0).ToString());
	...
	templateBuilder.Append("\r\n<!--/Footer-->\r\n    <script type=\"text/javascript\">\r\n        $(\".nav li a\").eq(3).addClass('animated jello').css(\"color\", \"#fff\");\r\n    </");
	templateBuilder.Append("script>\r\n</body>\r\n</html>");
